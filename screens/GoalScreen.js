...
import { cpShadow, hardDropShadow, subtleBorderShadow, cardShadow } from "../utils/shadows";
...
const styles = StyleSheet.create({
  ...
  historyStreakBadge: {
    ...
    flexDirection: 'row',
    alignItems: 'center',
    ...cpShadow({ color: '#f38a00', offset: { width: 0, height: 4 }, opacity: 1, radius: 0, elevation: 2 }),
  },
  historyStreakIcon: {
    width: 18,
    height: 18,
  ...
  modalHeaderButtonPrimary: {
    backgroundColor: '#59d700',
    ...cpShadow({ color: '#4aa93a', offset: { width: 0, height: 4 }, opacity: 1, radius: 0, elevation: 2 }),
  },
