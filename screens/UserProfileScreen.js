...
const styles = StyleSheet.create({
  ...
  // avatar removed
  userName: { fontSize: 24, fontWeight: "900", color: theme.text, margin: 10 },
  profileSub: { marginTop: 4, fontSize: 13, fontWeight: "700", color: theme.text2, marginBottom: 14 },
  statsCard: {
    flexDirection: "row",
    width: "100%",
  ...
  statNumber: { fontSize: 21, fontWeight: "900", color: "#2D5A27", marginBottom: 2 },
  statLabel: { fontSize: 11, color: "#6b7987", fontWeight: "900", letterSpacing: 0.8 },
  ...
  sectionLabel: { fontSize: 12, fontWeight: "900", color: '#ffffff', marginBottom: 8, textTransform: "uppercase", letterSpacing: 1 },
  infoCard: {
    backgroundColor: '#ffffff',
    borderRadius: 24,
  ...
  infoLabel: { fontSize: 14, fontWeight: "800", color: theme.text },
  infoValue: { fontSize: 14, fontWeight: "900", color: theme.text2 },
  ...
  achTextWrap: { flex: 1 },
  achievementTitle: { fontSize: 17, fontWeight: "900", color: theme.text, marginBottom: 3 },
  achievementDesc: { fontSize: 13, color: "#677786", fontWeight: "700", lineHeight: 18 },
